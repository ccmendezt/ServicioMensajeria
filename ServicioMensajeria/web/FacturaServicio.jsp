...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/facturaserv.css" type="text/css"/>
    ...
    <body>
        ...
        <div id="centrar">
            <button type="submit" class="btn btn-primary" <button onclick="window.location.href = 'InicioSesionCliente.jsp'">Inicio</button>
