...
<%
    ...
    String i_tipoServicio = "";
    if(tipoServicio.equals("ida")){
        i_tipoServicio = "Ida";
    }else{
        i_tipoServicio = "Ida y vuelta";
    }
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/preFactServ.css"/>
        <div id="banner">  
        </div>
        <div id="img">
    ...
    <body>
        ...
        <div id="centrar">
            <button type="submit" class="btn btn-primary" <button onclick="window.location.href = 'InicioSesionCliente.jsp'">Cancelar Servicio</button>
            <button type="submit" class="btn btn-primary" <button onclick="window.location.href = 'AgregarServicio'">Programar Servicio</button>
        </div>
    </body>
</html>
