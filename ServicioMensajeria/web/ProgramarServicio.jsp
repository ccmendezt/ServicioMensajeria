...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/estiloProg.css"/>
    ...
    <body onload="validarFecha()">
        ...
        <form action="ProgramarServicio" method="POST">
            <table class="inicio">
                <tr>
                    <th><label>Ciudad de servicio:</label></th>
                    <th><select name="ciudad" required>
                ...
                <tr>
                    ...
                    <td><input type="date" id="fInicio" name="fInicio" min="" required><br></td>
                </tr>
                <tr>
                    <td><label>Hora:</label></td>
                    <td><input type="time" id="fHoraInicio" name="fHoraInicio" min="" onchange="_validarHora()" required><br></td>
                </tr>
                <tr>
                    <td><label>Tipo de servicio:</label></td>
                    <td><select name="tipoServicio" id="tipoServicio" required>
                ...
                <tr>
                    ...
                    <td><select name="medioPago" required>
                            <option value="efectivo">Efectivo</option>
                            <option value="pse">PSE</option>
                        </select><br></td>
                </tr>
                <tr>
                    <td><label>Volumen de paquete:</label></td>
                    <td><select name="volumenPaquete" required>
                ...
                <tr>
                    <td><label>Numero de direcciones:</label></td>
                    <td><select name="nroDir" id="nroDir" required>
